...
namespace DatabaseMigration
{
    internal class DatabaseProvider
    {
        ...
        {
            var datapath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "Xunkong");
            Directory.CreateDirectory(Path.Combine(datapath, "Database"));
            _sqlitePath = Path.Combine(datapath, @"Database\XunkongData.db");
