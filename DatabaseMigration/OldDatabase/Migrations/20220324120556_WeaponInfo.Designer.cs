...
namespace Xunkong.Desktop.Migrations
{
    ...
    [Migration("20220324120556_WeaponInfo")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Xunkong.Core.Metadata.CharacterConstellationInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("PreviewConstellationId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Xunkong.Core.Metadata.CharacterInfo", b =>
                {
                    ...
                    b.Property<string>("CvJapanese")
                        .HasMaxLength(255)
                        .HasColumnType("TEXT");

                    b.Property<string>("CvKorean")
                        .HasMaxLength(255)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Xunkong.Core.Metadata.CharacterTalentInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<float>("CdTime")
                        .HasColumnType("REAL");

                    b.Property<int>("CharacterInfoId")
                        .HasColumnType("INTEGER");

                    b.Property<float>("CostElementValue")
                        .HasColumnType("REAL");
                    ...
                    b.Property<int>("MaxChargeNumber")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("Info_Character_Talent");
                });
            ...
            modelBuilder.Entity("Xunkong.Core.Metadata.WeaponSkill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Xunkong.Desktop.Models.GenshinUserAccount", b =>
                {
                    b.Property<string>("UserName")
                        .HasColumnType("TEXT");

                    b.Property<byte[]>("ADLPROD")
                        .IsRequired()
                        .HasColumnType("BLOB");
            ...
            modelBuilder.Entity("Xunkong.Core.Metadata.WeaponSkill", b =>
                {
                    b.HasOne("Xunkong.Core.Metadata.WeaponInfo", null)
                        .WithMany("Skills")
