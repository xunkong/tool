namespace Xunkong.Core.Old.TravelRecord
{
    [Table("TravelRecord_MonthDatas")]
    [Index(nameof(Year), nameof(Month))]
    [Index(nameof(Uid), nameof(Year), nameof(Month), IsUnique = true)]
    public class TravelRecordMonthData
    {
        [JsonIgnore]
        ...
        public List<TravelRecordPrimogemsMonthGroupStats> PrimogemsGroupBy { get; set; }
